...
test("notation parsing", function(t){
    testval2('8^2',64,Unit('none'));
    testval2('8ft^2',64,Unit('foot',2));
    testval2('1ft^3',1,Unit('foot',3));
    L("exponent notation");
    testval2('2.2e2',220);
    testval2('2.2E2',220);
    testval2('2e2',200)
    testval2('3e9',3*1000*1000*1000);
    testval2('2e-2',0.02);

    testval2('2*(10^2)',200);
    L("number ease of use");
    testval2('2_000_000',2*1000*1000);
    L("percentage");
    testval2('50%',0.5);
    testval2('36 * 45%',36*0.45);
...
//arithmetic with grouping
    ...
    testEval("(1+(2*3))",7);
    testEval("((1+2)*3)",9);
    testEval("((1+1)*(2+2))",(1+1)*(2+2));
    testEval("(5+(6*7))",5+(6*7));
    testEval("(5+((6*7)))",5+(6*7));
    testEval("((1+5)*((6*8)+(7+6)))",(1+5)*((6*8)+(7+6)));
...
//length
    testEval("50mm", { value:50, unit:'millimeters'});
//testEval("50in", { value:50, unit:'inches'});
//testEval("50in * 5", { value:50*5, unit:'inches'});
//testEval("50 * 5in", { value:50*5, unit:'inches'});
    testEval("500m + 1km", { value:1500, unit:'meters'});


//weight
    testEval("50g",   { value:50, unit:'grams'});
    testEval("50kg",  { value:50, unit:'kilograms'});
...
test("unit parsing", function(t) {
    compareUnit("40m",40,'meter');
    compareUnit("40m as feet",40,'foot');
    compareUnit("40 C",40,'celsius');
